...
// langIDToLang maps a Windows language identifier to a supported Lang.
// Traditional Chinese variants fall back to ZH (Simplified Chinese).
// Unsupported languages fall back to EN.
func langIDToLang(langID uint16) Lang {
	switch langID {
	// ── Chinese ──────────────────────────────────────────────
