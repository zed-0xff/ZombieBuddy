...
@Patch(className = "testjar.AdviceLocalTest", methodName = "calculate")
public class TargetPatchAdviceLocal {
    ...
    public static void enter(@Patch.Argument(0) int x,
        ...
        testjar.AdviceLocalTest.primitiveInitialized = (primitiveSum == 0);
        
        // Verify reference is initialized to null (default value)
        testjar.AdviceLocalTest.referenceInitialized = (referenceSum == null);
        ...
        testjar.AdviceLocalTest.enterCalled = true;
    }
    ...
    public static void exit(@Patch.Local("primitiveSum") int primitiveSum,
        ...
        testjar.AdviceLocalTest.localIntValue = primitiveSum;
        
        // Reference should still be null (unless assigned in enter, but assignment doesn't persist)
        testjar.AdviceLocalTest.localIntegerValue = referenceSum;
        
        testjar.AdviceLocalTest.exitCalled = true;
    }
}
